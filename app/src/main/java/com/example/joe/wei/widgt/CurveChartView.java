...
import com.example.joe.wei.utils.DisplayUtil;
...
public class CurveChartView extends View {
    ...
    private void init() {
        ...
        bluePaint = new Paint();
        bluePaint.setColor(Color.parseColor("#FF4081"));
    ...
    private void drawXCoordinateText(Canvas canvas) {
        blackPaint.setTextSize(DisplayUtil.sp2px(getContext(), 12));
        Log.e("drawXCoordinateText","---------------");
    ...
    private void drawYCoordinateNumber(Canvas canvas) {
        ...
        blackPaint.setTextSize(DisplayUtil.sp2px(getContext(), 10));
        for (int i = 0; i < 10; i++)
